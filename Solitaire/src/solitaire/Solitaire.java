...
public class Solitaire {
    ...
    void jokerB() {
        ...
        for (CardNode s = deckRear.next; s != deckRear; s = s.next) {
            if (s.next.cardValue == 28) {
                ...
                CardNode c2 = c1.next;
                CardNode n = c2.next;
                if (s.next.next.next == deckRear) {
                    deckRear = j;
                } else if (s.next.next == deckRear) {
                    deckRear = c2;
                } else if (s.next == deckRear) {
                    deckRear = c1;
                }
                s.next = c1;
                j.next = n;
    ...
    void tripleCut() {
        ...
        if (deckRear.cardValue == 27 || deckRear.cardValue == 28) {
            ...
            CardNode s = deckRear.next;
            while (s.next.cardValue != 27 && s.next.cardValue != 28) {
                s = s.next;
            }
            deckRear = s;
            return;
        ...
        if (deckRear.next.cardValue == 27 || deckRear.next.cardValue == 28) {
            CardNode s = deckRear.next;
            s = s.next;
            while (s.cardValue != 27 && s.cardValue != 28) {
                s = s.next;
            }
            deckRear = s;
            return;
    ...
    /**
     * @return Encrypted message, a sequence of upper and lower case letters only
     */
    ...
    /**
     * @return Decrypted message, a sequence of upper and lower case letters only
     */
